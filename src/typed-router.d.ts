...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/finalrestrictionrelease/': RouteRecordInfo<'/finalrestrictionrelease/', '/finalrestrictionrelease', Record<never, never>, Record<never, never>>,
    '/finalrestrictionrelease/[season]/': RouteRecordInfo<'/finalrestrictionrelease/[season]/', '/finalrestrictionrelease/:season', { season: ParamValue<true> }, { season: ParamValue<false> }>,
