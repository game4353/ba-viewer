...
import {
  ExtraFrameData,
  NormalAttackPhase,
  NormalAttackPhaseNameList,
  tidyPhaseData,
} from "./phaseData";

const props = defineProps({
  phase: {
    type: Object as PropType<ReadonlyDeep<z.infer<typeof NormalAttackPhase>>>,
    required: true,
  },
  frame: {
    type: Array as PropType<ReadonlyDeep<z.infer<typeof ExtraFrameData>[]>>,
    required: true,
  },
});
